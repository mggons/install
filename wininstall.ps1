...
$WPFinstall.Add_Click({
    ...
    {
        Start-Process powershell.exe -Verb RunAs -ArgumentList "-command winget install -e --accept-source-agreements --accept-package-agreements --silent --force $node | Out-Host" -Wait -WindowStyle Normal
    ...
    $MessageboxTitle = "Programas Instalados"
